<?php
/*
 * Core/View/ForbiddenView.php - Copyright 2009 Dennis Cohn Muroy
 *
...
/**
 * Class that implements the 403 error code View.
 * @package Core
 * @subpackage View
 ...
 */
class Core_View_ForbiddenView extends Base_View
{
